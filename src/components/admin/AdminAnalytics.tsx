...
import { LuEye, LuTrendingUp, LuDatabase, LuBox, LuImage, } from 'react-icons/lu';
    ...
    <div className={Styles.adminAnalytics}>
      ...
      <div className={Styles.adminAnalyticsContainer}>
        <div className={Styles.adminAnalyticsBox}>
          <LuBox/>
          <p>Supabase</p><br/>
          <div>28% <span>Table</span></div><br/>
          <div>16.29% <span>Image</span></div>
        </div>
        <div className={Styles.adminAnalyticsBox}>
          <LuImage/>
          <p>ImageKit</p><br/>
          <div>28% <span>Videos</span></div><br/>
          <div>16.29% <span>Images</span></div>
        </div>
      </div>
    </div>
  );
